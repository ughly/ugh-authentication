...
class AdapterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAdapterSuccessor()
    {
        ...
        $invalidAdapterMock = $this->getMockBuilder('UghAuthentication\Authentication\Adapter\ChainableAdapter', array('doAuthentication'))->disableOriginalConstructor()->getMockForAbstractClass();
        ...
        $validAdapterMock = $this->getMockBuilder('UghAuthentication\Authentication\Adapter\ChainableAdapter', array('authenticate'))->disableOriginalConstructor()->getMockForAbstractClass();
    ...
    public function testAdapterSuccessorDoesntGetCalledOnValidResult()
    {
        ...
        $firstValidAdapterMock = $this->getMockBuilder('UghAuthentication\Authentication\Adapter\ChainableAdapter', array('doAuthentication'))->disableOriginalConstructor()->getMockForAbstractClass();
        $firstValidAdapterMock->expects($this->once())->method('doAuthentication')->will($this->returnValue($validResult));


        $secondValidAdapterMock = $this->getMockBuilder('UghAuthentication\Authentication\Adapter\ChainableAdapter', array('authenticate'))->disableOriginalConstructor()->getMockForAbstractClass();
